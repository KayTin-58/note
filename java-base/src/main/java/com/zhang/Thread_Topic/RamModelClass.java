 ...
 *       于本地主内存中，在主内存中的num变量的值依然等于1， 在thread_01
 *       线程对num的操作还没有结束的时候thread_02进入了操作num的代码快，此刻他看到的num也是本地内存的num=1,所以会导致错误
 *
...
public class RamModelClass {
    ...
    public static void main(String[] args) {
        ...
        ThreadPoolExecutor threadPoolExecutor =
                        new ThreadPoolExecutor(5, 5, 100, TimeUnit.MILLISECONDS, new ArrayBlockingQueue<Runnable>(10));
        // 同时启动像个线程
    ...
    static class MyThraed implements Runnable {
        ...
        public String toString() {
            return "MyThraed{" + "thredName='" + thredName + '\'' + '}';
        }
    }
}
